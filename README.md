...
## Install Plugin
First you will need to install freeRASP for unity. Head over to [Github Unity Plugin Release Link](https://github.com/talsec/Free-RASP-Unity-POC/releases/download/0.2.0/freeRASP.unitypackage). Download the latest plugin. Notice the plugin file ends with .unitypackage
